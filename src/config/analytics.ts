 ...
 *
 * This file contains configuration for the similarity engine and other analytics features.
 * Adjust these values to fine-tune how trade setups are compared and analyzed.
 */
 ...
 * You can switch to these or create your own based on your trading style
 */
 ...
 * You can modify this function to load from environment variables,
 * user preferences, or other sources in the future
 */
export function getAnalyticsConfig(): AnalyticsConfig {
  // For now, return the default config
  // In the future, you could:
  // - Load from environment variables
  // - Load from user preferences in database
  // - Load from local storage
  // - Allow runtime switching between presets
